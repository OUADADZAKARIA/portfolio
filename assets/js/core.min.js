...
(function($) {
    ...
    $(".style1").on("click", function() {
        ...
        $("#logo").attr("src", "http://www.3wa.ma/wp-content/uploads/2019/10/logo-final-3wa-5.png");
        $(".header-style6 #logo").attr("src", "http://www.3wa.ma/wp-content/uploads/2019/10/logo-final-3wa-5.pngmg/logos/logo-white.png");
        $(window).on('scroll', function() {
            var scroll = $(window).scrollTop();
            var logostyle1 = $(".navbar-brand img");
            if (scroll <= 50) {
                logostyle1.attr('src', 'http://www.3wa.ma/wp-content/uploads/2019/10/logo-final-3wa-5.png');
                $(".header-style6 #logo").attr("src", "http://www.3wa.ma/wp-content/uploads/2019/10/logo-final-3wa-5.png");
            } else {
                logostyle1.attr('src', 'http://www.3wa.ma/wp-content/uploads/2019/10/logo-final-3wa-5.png');
                $(".header-style6 #logo").attr("src", "http://www.3wa.ma/wp-content/uploads/2019/10/logo-final-3wa-5.png");
            }
...
function initMap() {
    var e = new google.maps.StyledMapType([{
        ...
        t = new google.maps.LatLng(32.754446, -97.224821),
        l = {
            zoom: 12,
            center: t
        },
